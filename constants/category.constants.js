...
const updateCategoryQuery = 'UPDATE categories SET name = ?, type = ?, user_id = ? where id = ?';

module.exports = { getAllCategories, createCategoryQuery, getCategoryByIdQuery, updateCategoryQuery }